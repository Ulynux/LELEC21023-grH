...
#define MIN_PA_LEVEL -40 // initial Tx transmit power, in dBm
#define MAX_PA_LEVEL -25 // final Tx transmit power, in dBm
#define N_PACKETS 300 // number of packets transmitted for each Tx power level
