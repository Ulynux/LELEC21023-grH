...
plt.savefig('power_measurement/DATA_POWER/Total_power.png')
plt.show()
...
plt.savefig('power_measurement/DATA_POWER/Total_power_cycle.png')
plt.show()
...
plt.axvline(x=0.596, color='r', linestyle='--')
plt.axvline(x=0.73, color='r', linestyle='--')
plt.savefig('power_measurement/DATA_POWER/MCU_power_cycle.png')
plt.show()
...
plt.grid(True, linestyle='--', alpha=0.6)
plt.savefig('power_measurement/DATA_POWER/AFE_current.png')
plt.show()
...
# plt.ylabel('Current (uA)')
# plt.grid(True, linestyle='--', alpha=0.6)
# plt.savefig('power_measurement/DATA_POWER/AFE_power.png')
# plt.show()
...
plt.ylabel('Power (mW)')
plt.grid(True, linestyle='--', alpha=0.6)
plt.savefig('power_measurement/DATA_POWER/Radio_power.png')
plt.show()
