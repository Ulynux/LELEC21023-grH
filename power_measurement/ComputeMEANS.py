...
# Pour calculer la puissance moyenne
puissanceCNT = 0
tempsCNT = 0
resultat = 0
...
plt.plot(time, power)
plt.title('Total power consumption XXX')
plt.xlabel('Temps (s)')
plt.ylabel('Power (mW)')
plt.grid(True, linestyle='--', alpha=0.6)
plt.show()
"""
# VALEUR DE REF 3200 15500
# PART 1 3200 a 13260 (pour avoir le dernier pic)
# PART 2 13260 a 14180 (pour avoir le pic)
# PART 3 14180 a 15500
time = df['Time(S)'][3200:15500]
ch1 = df['CH1(V)'][3200:15500] + 0.026
power = ch1/10 * 3.3 * 1000    # in mW, I*U, I = ch1/R, R = 10 Ohm, U = 3.3V

for i in power :
    puissanceCNT = puissanceCNT + i
    tempsCNT = tempsCNT + 1
resultat = puissanceCNT/tempsCNT
print("taille", len(power))
print('-----------------')
print("puis", puissanceCNT)
print("temps", tempsCNT)
print("PCM", resultat)
...
time = df['Time(S)'][200:12600] + 0.301
ch1 = df['CH1(V)'][200:12600] + 0.026
power = ch1/10 * 3.3 * 1000    # in mW, I*U, I = ch1/R, R = 10 Ohm, U = 3.3V
...
time = df['Time(S)'][13500:61000]
ch1 = df['CH1(V)'][13500:61000] + 0.026
power = ch1/10 * 3.3 * 1000    # in mW, I*U, I = ch1/R, R = 10 Ohm, U = 3.3V
...
plt.ylabel('Power (mW)')
plt.grid(True, linestyle='--', alpha=0.6)
# plt.axvline(x=0.5, color='r', linestyle='--') # a aider pour trouver la bordure
plt.show()
"""
